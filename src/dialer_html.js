  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .learn-header {
      ...
      background: var(--card-bg); border-bottom: 0.5px solid var(--card-border);
      position: sticky; top: 0; z-index: 10;
      backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px);
      background: rgba(242,242,247,0.85);
    }
    body.dark-mode .learn-header { background: rgba(28,28,30,0.85); }
    .learn-header-title {
    ...
    .learn-close-btn {
      ...
      color: var(--text-soft); cursor: pointer; outline: none; font-weight: 600;
  ...
  <div class="app-shell">
    <div class="container">
      ...
      <div class="header-bar">
        ...
        <button id="learnBtn" title="学习" onclick="document.getElementById('learnOverlay').classList.add('active'); document.body.style.overflow='hidden';" style="font-size: 0.78rem; padding: 4px 8px; border: none; background: transparent; color: #4a6cf7; cursor: pointer; outline: none; font-weight: 700; border-radius: var(--radius-sm); margin-right: 8px; white-space: nowrap; display: inline-flex; align-items: center; justify-content: center;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg></button>
...
<div class="db-overlay" id="dbOverlay">
  ...
  <div class="learn-overlay" id="learnOverlay">
    <div class="learn-header">
      ...
      <button class="learn-close-btn" onclick="document.getElementById('learnOverlay').classList.remove('active'); document.body.style.overflow='';">关闭</button>
    </div>
    <div class="learn-body">
      <div class="learn-article">
        ...
        <div class="learn-toc">
          ...
          <a href="#l1" onclick="document.getElementById('l1').scrollIntoView({behavior:'smooth'})">一、核心目标与增长模型</a>
          <a href="#l2" onclick="document.getElementById('l2').scrollIntoView({behavior:'smooth'})">二、设备与账号配置</a>
          <a href="#l3" onclick="document.getElementById('l3').scrollIntoView({behavior:'smooth'})">三、加人操作细则</a>
          <a href="#l4" onclick="document.getElementById('l4').scrollIntoView({behavior:'smooth'})">四、加人后的转化与筛选</a>
          <a href="#l5" onclick="document.getElementById('l5').scrollIntoView({behavior:'smooth'})">五、微信养号与权重提升</a>
          <a href="#l6" onclick="document.getElementById('l6').scrollIntoView({behavior:'smooth'})">六、群发与朋友圈运营</a>
          <a href="#l7" onclick="document.getElementById('l7').scrollIntoView({behavior:'smooth'})">七、客户跟进与裂变</a>
          <a href="#l8" onclick="document.getElementById('l8').scrollIntoView({behavior:'smooth'})">八、工作习惯及达到的要求</a>
          <a href="#l9" onclick="document.getElementById('l9').scrollIntoView({behavior:'smooth'})">九、微信使用规范和养号技巧汇总</a>
        </div>
        ...
        <ul>
          <li><strong>使用PC端微信：</strong>PC版微信进行手动添加操作比手机端更快捷高效</li>
        </ul>
